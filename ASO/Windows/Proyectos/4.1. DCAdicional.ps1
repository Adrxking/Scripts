...
Write-Output " " 
New-NetIpAddress -InterfaceIndex 25 -IpAddress 192.168.7.168 -PrefixLength 24 -DefaultGateway 192.168.7.254 -AddressFamily IPv4 -Confirm:$False > $Null
Write-Output " " 
write-host -foregroundcolor YELLOW -nonewline "    Hecho. " 
Write-Output " "
